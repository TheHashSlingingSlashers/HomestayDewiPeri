<%-- 
    Document   : input-penyewa-hs
    Created on : Mar 6, 2017, 7:49:51 PM
        ...
        <div id="wrapper">
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a class="active" href="kelola-penyewa.jsp">Kelola Penyewa Homestay</a>
                                    </li>
                                    <li>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Manajemen Homestay</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
