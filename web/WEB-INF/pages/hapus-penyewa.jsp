                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a class="active" href="hapus-penyewa.jsp">Hapus Penyewa</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
                                    ...
                                    <form class="form-horizontal" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" class="form-control col-md-7 col-xs-12" id="noIdentias" readonly="readonly">
                                            </div>
                                        </div>
                                        <!-- /.form-group -->                                    
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" class="form-control col-md-7 col-xs-12" id="nama" readonly="readonly">
                                            </div>
                                        </div>
                                        <!-- /.form-group -->
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" class="form-control col-md-7 col-xs-12" id="alamat" readonly="readonly">
                                            </div>
                                        </div>
                                        <!-- /.form-group -->
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" class="form-control col-md-7 col-xs-12" id="telepon" readonly="readonly">
                                            </div>
                                        </div>
                                        <!-- /.form-group -->
                                        <div class="form-group">
