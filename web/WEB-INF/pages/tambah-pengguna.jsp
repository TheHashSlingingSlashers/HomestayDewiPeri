                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="radio radio-inline radio-primary">
                                            <input type="radio" name="role" id="inlineRadio1" value="S"
                                                   class="sr-only" required>
                                            <label for="inlineRadio1">Admin</label>
                                        </div>
                                        <div class="radio radio-inline radio-primary">
                                            <input type="radio" name="role" id="inlineRadio3" value="P"
                                                   class="sr-only" required>
                                ...
                                <div class="modal-dialog modal-md">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" data-toggle="modal" data-target="#myModal" id="btnOK"
                                                    data-dismiss="modal" class="btn btn-success">OK
                                            </button>
                                        </div>
                                    </div>
                                </div>
