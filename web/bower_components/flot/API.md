...
Here's a complete app of a simple data specification:
...
function for "labelFormatter". Here's an app that makes them
clickable:
...
the number of the axis when there are multiple axes.  For app, the x-axis
...
the transform function. Here's an app, the x axis can be turned
...
Here's an app of configuring a single x axis and two y axes (we
...
a custom tick formatter function as usual. Here's a simple app
...
border of the plot. So for app if you only specify { xaxis: {
...
An app function that makes vertical stripes might look like this:
...
The item object in this app is either null or a nearby object on the form:
...
can call:
 ...
 - setupGrid()
    ...
    Note that because of the drawing app.model of the canvas, this
...
hooks in the plugins bundled with Flot.
 ...
 - processRawData  [phase 3]
    ...
    format array, for app, looks like this:
 ...
 - bindEvents  [phase 6]
    ...
    user code. See the crosshair plugin for an app.
 ...
 - drawOverlay  [phase 7]
    ...
    canvas to draw on. The app.model currently used by Flot works the way
