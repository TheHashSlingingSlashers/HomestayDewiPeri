<%-- 
    Document   : hapus-homestay
    Created on : Feb 16, 2017, 11:39:26 AM
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a class="active" href="hapus-homestay.jsp">Hapus Homestay</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading"> Hapus Homestay</div>
                                <div class="panel-body">
                                    <form class="form-horizontal" role="form">
                                        <div class="form-group">
                                            <label class="col-md-2 col-sm-2 col-xs-12">Kode Homestay</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" class="form-control col-md-7 col-xs-12" id="kodeHomestay" readonly="readonly">
                                            </div>
                                        </div>
                                        <!-- /.form-group -->
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" class="form-control col-md-7 col-xs-12" id="namaPemilik" readonly="readonly">
                                            </div>
                                        </div>
                                        <!-- /.form-group -->
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input type="text" class="form-control col-md-7 col-xs-12" id="lokasi" readonly="readonly">
                                            </div>
                                        </div>
                                        <!-- /.form-group -->                                     
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input type="text" class="form-control" id="jumlahKamar" readonly="readonly">
                                            </div>
                                        </div>
                                        <!-- /.form-group -->
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input type="text" class="form-control" id="jumlahTempatTidur" readonly="readonly">
                                            </div>
                                        </div>
                                        <!-- /.form-group -->
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input type="text" class="form-control" id="jumlahToilet" readonly="readonly">
                                            </div>
                                        </div>
                                        <!-- /.form-group -->
                                        <div class="col-md-offset-2 col-sm-offset-2">
                                            <button type="button" class="btn btn-labeled btn-danger"><span class="btn-label"><i class="glyphicon glyphicon-floppy-disk"></i></span> Hapus</button>    
                                        </div>
